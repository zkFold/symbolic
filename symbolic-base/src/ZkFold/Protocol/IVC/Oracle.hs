...
instance
  (OracleSource a b, OracleSource a c, OracleSource a d)
...
instance
  (Foldable f, OracleSource a b)
  => OracleSource a (FoldableSource f b)
  where
...
deriving via
  (FoldableSource [] b)
  instance
    OracleSource a b => OracleSource a [b]

deriving via
  (FoldableSource (Vector n) b)
  instance
    OracleSource a b => OracleSource a (Vector n b)
...
instance
  (GOracleSource a f, GOracleSource a g)
  => GOracleSource a (f :*: g)
  where
