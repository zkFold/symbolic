...
instance ( Field f, Eq f, Conditional (BooleanOf f) (Ext2 f e)
         , IrreduciblePoly poly f e ) => Field (Ext2 f e) where
    finv (Ext2 a b) =
...
instance ( Field f, Eq f, Conditional (BooleanOf f) (Ext3 f e)
         , IrreduciblePoly poly f e) => Field (Ext3 f e) where
    finv (Ext3 a b c) =
