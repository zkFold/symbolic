...
instance (Context (GooglePayload ctx) ~ ctx, Symbolic ctx) => IsSymbolicJSON (GooglePayload ctx) where
  ...
  toJsonBits GooglePayload {..} =
    (fromType @"{\"iss\":\"")
      @+ plIss
      `VB.append` (fromType @"\",\"azp\":\"")
      @+ plAzp
      `VB.append` (fromType @"\",\"aud\":\"")
      @+ plAud
      `VB.append` (fromType @"\",\"sub\":\"")
      @+ plSub
      `VB.append` (fromType @"\",\"hd\":\"")
      @+ plHd
      `VB.append` (fromType @"\",\"email\":\"")
      @+ plEmail
      `VB.append` (fromType @"\",\"email_verified\":")
      @+ plEmailVerified
      `VB.append` (fromType @",\"at_hash\":\"")
      @+ plAtHash
      `VB.append` (fromType @"\",\"name\":\"")
      @+ plName
      `VB.append` (fromType @"\",\"picture\":\"")
      @+ plPicture
      `VB.append` (fromType @"\",\"given_name\":\"")
      @+ plGivenName
      `VB.append` (fromType @"\",\"family_name\":\"")
      @+ plFamilyName
      `VB.append` (fromType @"\",\"iat\":")
      @+ plIat
