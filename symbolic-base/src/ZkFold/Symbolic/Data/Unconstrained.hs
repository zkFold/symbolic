...
instance Foldable f => Collect (ConstrainedDatum c) (Vec f c) where
  collect = toDatum FieldElement . runVec

deriving via (Vec Par1 c) instance Collect (ConstrainedDatum c) (FieldElement c)

deriving via (Vec Par1 c) instance Collect (ConstrainedDatum c) (Bool c)
