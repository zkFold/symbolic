...
examples =
  ...
  , ("Reverse.32.3000", exampleOutput @A $ exampleReverseList @32 @(CompatData (ByteString 3000)) @(Elem A)) -- TODO: should be 3000*32 == 96000 constraints
  ...
  , ("UInt.Extend.1.512", exampleOutput @A $ exampleUIntResize @1 @512 @Auto @(Elem A))
  , ("UInt.Truncate.512.1", exampleOutput @A $ exampleUIntResize @512 @1 @Auto @(Elem A))
  , ("UInt.Truncate.74.54", exampleOutput @A $ exampleUIntResize @74 @54 @Auto @(Elem A))
  , ("UInt.StrictAdd.256.Auto", exampleOutput @A $ exampleUIntStrictAdd @256 @Auto @(Elem A))
  , ("UInt.StrictMul.512.Auto", exampleOutput @A $ exampleUIntStrictMul @512 @Auto @(Elem A))
  , ("UInt.Mul.64.Auto", exampleOutput @A $ exampleUIntMul @64 @Auto @(Elem A))
  , ("UInt.Mul.4096.Auto", exampleOutput @A $ exampleUIntMul @4096 @Auto @(Elem A))
  , ("UInt.LEQ.256.Auto", exampleOutput @A $ exampleUIntLeq @256 @Auto @(Elem A))
  , ("UInt.ProductMod.1024.Auto", exampleOutput @A $ exampleUIntProductMod @1024 @Auto @(Elem A))
  , ("UInt.DivMod.32.Auto", exampleOutput @A $ exampleUIntDivMod @32 @Auto @(Elem A))
  , ("UInt.ExpMod.32.16.64.Auto", exampleOutput @A $ exampleUIntExpMod @32 @16 @64 @Auto @(Elem A))
  , ("UInt.ExpMod.256.64.1024.Auto", exampleOutput @A $ exampleUIntExpMod @256 @64 @1024 @Auto @(Elem A))
