...
import ZkFold.Symbolic.Examples.Jubjub (exampleJubjubAdd, exampleJubjubEdDSA, exampleJubjubScale)
import ZkFold.Symbolic.Examples.LEQ (exampleLEQ)
import ZkFold.Symbolic.Examples.MerkleTree (exampleMerkleTreeReplace)
...
import ZkFold.Symbolic.Examples.PoseidonHash (examplePoseidon)
...
examples =
  ...
  , ("Jubjub.Add", exampleOutput @A exampleJubjubAdd)
  , ("Jubjub.Scale", exampleOutput @A exampleJubjubScale)
  , ("Jubjub.EdDSA.MiMC", exampleOutput @A exampleJubjubEdDSA)
  ...
  , ("PoseidonHash", exampleOutput @A examplePoseidon)
