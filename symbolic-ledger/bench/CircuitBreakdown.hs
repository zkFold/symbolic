...
main = do
  ...
  putStrLn $
    metrics
      "Balance check (a=1, 1in vs 1out)"
      (C.compileV1 @RollupBF (balanceCheckCircuit @1))
  putStrLn $
    metrics
      "Balance check (a=2, 1in vs 1out)"
      (C.compileV1 @RollupBF (balanceCheckCircuit @2))
  putStrLn $
    metrics
      "Balance check (a=5, 1in vs 1out)"
  ...
  putStrLn $
    metrics
      "Output sanity check (a=1)"
      (C.compileV1 @RollupBF (sanityCkCircuit @1))
  putStrLn $
    metrics
      "Output sanity check (a=2)"
  ...
  putStrLn $
    metrics
      "Full Ledger bi=1 bo=1 ud=2 a=1 s=1 n=1 t=1"
      (ledgerCircuit @1 @1 @2 @1 @1 @1 @1 @RollupBFInterpreter)
  putStrLn $
    metrics
      "Full Ledger bi=1 bo=1 ud=20 a=1 s=1 n=1 t=1"
      (ledgerCircuit @1 @1 @20 @1 @1 @1 @1 @RollupBFInterpreter)
  putStrLn $
    metrics
      "Full Ledger bi=1 bo=1 ud=2 a=2 s=2 n=2 t=2"
