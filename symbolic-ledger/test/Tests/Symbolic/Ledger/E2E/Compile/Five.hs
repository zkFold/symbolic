module Tests.Symbolic.Ledger.E2E.Compile.Five (specE2ECompileFive) where
...
import ZkFold.Symbolic.Ledger.Examples.Five

specE2ECompileFive :: Spec
specE2ECompileFive =
  it "E2E ledger circuit, Five: prove and verify" $ do
