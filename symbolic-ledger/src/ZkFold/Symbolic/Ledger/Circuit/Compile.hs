...
import GHC.Generics (Par1, (:*:), U1, Generic, Generic1)
...
ledgerContract :: forall bi bo ud a i o t c. SignatureState bi bo ud a c => SignatureTransactionBatch ud i o a t c => LedgerContractInput bi bo ud a i o t c -> LedgerContractOutput c
...
type LedgerContractInputPayload bi bo ud a i o t c = Payload (LedgerContractInput bi bo ud a i o t) (Order (BaseField c))
type LedgerContractCompiledInput bi bo ud a i o t c = (LedgerContractInputPayload bi bo ud a i o t c :*: U1) :*: (LedgerContractInputLayout bi bo ud a i o t c :*: U1)
type LedgerCircuit bi bo ud a i o t c = ArithmeticCircuit Fq (LedgerContractCompiledInput bi bo ud a i o t c) Par1

ledgerCircuit :: forall bi bo ud a i o t c. SignatureState bi bo ud a c => SignatureTransactionBatch ud i o a t c => LedgerCircuit bi bo ud a i o t c
